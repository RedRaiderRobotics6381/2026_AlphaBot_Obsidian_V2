...
public class AutoAutoShooter extends Command {
    ...
    public void execute(){
        ...
        m_rotate.setRotateAngleCmd(angle);
            ...
            if(Math.abs(m_rotate.armAngMtr.getPosition().getValueAsDouble() - angle) <= 1 && Math.abs(m_outtake.wheelSpeedMtr.getVelocity().getValueAsDouble() - ConstantValues.SHOOTER_RPM) <= 30){
