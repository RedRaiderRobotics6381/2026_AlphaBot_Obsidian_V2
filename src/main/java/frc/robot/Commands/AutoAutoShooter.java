...
//     public AutoAutoShooter(Outtake m_outtake, RotateSubsystem m_rotate, Indexer m_indexer, CommandSwerveDrivetrain drivetrain) {
...
//             if(Math.abs(m_rotate.sliderLdrMtr.getPosition().getValueAsDouble() - angle) <= 1 && Math.abs(m_outtake.wheelSpeedMtr.getVelocity().getValueAsDouble() - ConstantValues.SHOOTER_RPM) <= 30){
