...
public class Constants {
  ...
  public static class IndexerConstants {
    public static final int INDEXER_MOTOR_PORT = 30;
    public static final int UPTAKE_WHEELS_PORT = 28;
    public static final int UPTAKE_BELT_PORT = 10;
  }

  public static class IntakeConstants {
    public static final int INTAKE_MOTOR_PORT_1 = 26;
    public static final int INTAKE_MOTOR_PORT_2 = 35;
  }

  public static class IntakeSliderConstants {
    public static final int INTAKE_SLIDER_MOTOR_PORT_LDR = 15;
    public static final int INTAKE_SLIDER_MOTOR_PORT_FLW = 38;
  ...
  public static class RotationConstants {
    public static final int ROTATION_MOTOR_PORT = 27;
  ...
  public static class OuttakeConstants {
    public static final int OUTTAKE_MOTOR_UPPER_PORT = 11;
    public static final int OUTTAKE_MOTOR_LOWER_PORT = 29;
  ...
  // }
    ...
    public static class Vision {
        ...
        public static final Transform3d kFrontRobotToCam =
                new Transform3d(new Translation3d(-0.311, 0.105, 0.494), new Rotation3d(0, Math.PI/6, 0));
        public static final Transform3d kBackRobotToCam =
                new Transform3d(new Translation3d(-0.342, 0.275, 0.494), new Rotation3d(0, Math.PI/6, Math.PI));
        ...
        public static final Transform3d kRadioRobotToCam =
                new Transform3d(new Translation3d(-0.272, 0.343, 0.494), new Rotation3d(0, Math.PI/6, Math.PI / 2));
  ...
  public static class ConstantValues {
    ...
    public static double SHOOTER_RPS_NEAR = 25;//25
    public static double SHOOTER_SPEED_NEAR = 298;
    public static double SHOOTER_RPS_FAR = 30;//30
